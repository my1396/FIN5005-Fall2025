...
This guide helps you set up your coding environment for FIN5005, including both cloud and local solutions. You will learn how to use RStudio Cloud for quick access and RStudio Desktop for full features.  

**You are strongly recommended to install the local version ([RStudio Desktop](#RStudio-Desktop)) on your computer.** Follow the instructions below to get started.
