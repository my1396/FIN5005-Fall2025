...
{\color{red}\overline{X}} & {\color{red}\xrightarrow{d} N(\mu, \frac{\sigma^2}{n})}
\end{split}
$$
:::
...
$$
P(\overline{X} > 42) = P(\frac{\overline{X} - \mu}{\sigma/\sqrt{n}} > \frac{\overline{X} - 40}{1.875}) = P(Z > 1.067)
$$
